...
const BlogDetails = () => {
  ...
  return (
    <div className="lg:px-20 sm:px-8 py-10 w-full max-w-7xl mx-auto flex flex-col justify-center items-center">
      {/* BLOG HEADING */}
      <div className=" my-16 flex lg:flex-row sm:flex-col justify-between lg:items-center sm:items-start w-full">
        <p className="text-4xl font-bold">{blogDetails?.data?.blogTitle}</p>
        <p>
      ...
      {/* CREATED BY ADMIN */}
      <div className="bg-gray-200 p-12 flex justify-between w-full">
        <div>
